            ...
            <div class="flex-it py-1 px-4 flex-row">
                <div class="flex-it mr-4">
                    <div class="w-12 h-12 overflow-visible cursor-pointer transition duration-200 hover:opacity-80">
                        <img
                            class="rounded-full"
                            src="https://www.pinclipart.com/picdir/middle/133-1331433_free-user-avatar-icons-hHomeScreeny-flat-design-png.png"
                        ></img>
                    </div>
                </div>
                {/* MESSENGER START */}
                <div class="flex-it flex-grow">
                    ...
                    <div class="flex-it mb-1 flex-row xs:justify-between items-center">
                        ...
                        <div class="flex-it w-32 mt-3 cursor-pointer">
                            <button
                                onClick={() => { createGlide(); setContent(""); }}
                                type="button"
                                class="
